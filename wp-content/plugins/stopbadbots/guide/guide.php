...
for example, sometimes send bots with empty user agent (or another bad practice) and our system catch them.','stopbadbots'); 
...
$ah_help .= 'You have also the option to deactivate Yandex bot.';
$ah_help .= '<br>';
$ah_help .= 'Dashboard => Stop Bad Bots => Bad Bots Table.';
$ah_help .= '<br>';
$ah_help .= 'Deactivate this 3 boots:';
$ah_help .= '<br>';
$ah_help .= '1) Yandex';
$ah_help .= '<br>';
$ah_help .= '2) Yandexbot';
...
$ah_help .= __('Visit the plugin site for more details, video, online guide, FAQ and Troubleshooting page and bot\'s and IP\'s details.','stopbadbots');
$ah_help .= '<br>';
$ah_help .= '<br>';
$ah_help .= '<a href="https://stopbadbots.com/help/" class="button button-primary">'.__("OnLine Guide","stopbadbots").'</a>';
$ah_help .= '&nbsp;&nbsp;';
$ah_help .= '<a href="https://stopbadbots.com/faq/" class="button button-primary">'.__("Faq Page","stopbadbots").'</a>';
$ah_help .= '&nbsp;&nbsp;';
$ah_help .= '<a href="https://billminozzi.com/dove/" class="button button-primary">'.__("Support Page","stopbadbots").'</a>';
$ah_help .= '&nbsp;&nbsp;';
$ah_help .= '<a href="https://siterightaway.net/troubleshooting/" class="button button-primary">'.__("Troubleshooting Page","stopbadbots").'</a>';
$ah_help .= '&nbsp;&nbsp;';
$ah_help .= '<a href="https://stopbadbots.com/premium/" class="button button-primary">'.__("Go Pro","stopbadbots").'</a>';
$ah_help .= '<br>';
$ah_help .= '<br>';

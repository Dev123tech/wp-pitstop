			...
			<div class="bill-vote-wrap">
				...
				<div class="bill-vote-message">
                    ...
                    <?php 
                       ...
                       echo '. ';
                       _e( 'If you like this product, please write a few words about it. It will help other people find this useful plugin more quickly.<br><b>Thank you!</b>', 'stopbadbots' ); ?></p>
					<p>

...
$msg2 .= '<br />'; 
$msg2 .= '<b>'.__('Block Engine Management let you manage the user agent filter, Server CPU utilization and other things','stopbadbots').'</b>';
$msg2 .= '<br />'; 
$msg2 .= __('Maximum Block option: maybe can generate false positives if your user use Proxy, VPN or block cookie and/or javascript for example.','stopbadbots');
$msg2 .= '<br />'; 
$msg2 .= __('Conservative option:  probably will let pass some very smart bots but don\'t generate false positives.','stopbadbots');
$msg2 .= '<br />'; 
$msg2 .= __('Normal option:  try to keep the balance between Conserative and Maximum Block.','stopbadbots');

$msg2 .= '<br />'; 
$msg2 .= __('The default option is Normal.','stopbadbots');
$msg2 .= '<br />'; 
$msg2 .= __('Maximum Block works only in Pro version.','stopbadbots');
...
$fields[] = array(
	...
	$fields[] = array(
		...
		'label' => __('Block all bots included at Bad Referer Table?'),
		'radio_options' => array(
			array('value'=>'yes', 'label' => __('yes')),
			array('value'=>'no', 'label' => __('no'))
			)			
	...
	$fields[] = array(
			'type' 	=> 'radio',
			'name' 	=> 'stop_bad_bots_engine_option',
			'label' => __('Block Engine Management (Maximum Block is available only in pro version)'.'  '. $pro_enabled),
			'radio_options' => array(
				array('value'=>'conservative', 'label' => __('Conservative')),
				array('value'=>'normal', 'label' => __('Normal')),
				array('value'=>'maximum', 'label' => __('Maximum Block'))
				)			
			);
    
$fields[] = array(
	'type' 	=> 'radio',
	'name' 	=> 'stop_bad_bots_firewall',
	'label' => __('Enable Firewall? (available only in pro version)').'  '. $pro_enabled,
	'radio_options' => array(
		array('value'=>'yes', 'label' => __('yes')),
		array('value'=>'no', 'label' => __('no'))
		)			
...
$fields[] = array(
	...
	'label' => __('Receive bot\'s table updates by participate in the Real-Time Bad Bots Security Network?'),
	'radio_options' => array(
		array('value'=>'yes', 'label' => __('yes')),
		array('value'=>'no', 'label' => __('no'))
		)			
...
$fields[] = array(
		'type' 	=> 'radio',
		'name' 	=> 'stop_bad_bots_autoupdate',
		'label' => __('Update this plugin automatically when new version is available?'),
		'radio_options' => array(
			array('value'=>'yes', 'label' => __('yes')),
			array('value'=>'no', 'label' => __('no'))
			)			
	...
	$fields[] = array(
		...
		'label' => __('Block all with Blank User Agent?'),
		'radio_options' => array(
			array('value'=>'yes', 'label' => __('yes')),
			array('value'=>'no', 'label' => __('no'))
			)			
	...
	$fields[] = array(
		...
		$fields[] = array(
			...
			'label' => __('How long keep the visitors log file? If you have a very heavy traffic, select 1 day','stopbadbots'),
			'id' => 'my_select', // (optional, will default to name)
			'value' => 'red', // (optional, will default to '')
			'select_options' => array(
				array('value'=>'30', 'label' => __('Select', "stopbadbots")),
				array('value'=>'1', 'label' => __('1 day', "stopbadbots")),
				array('value'=>'3', 'label' => __('3 days', "stopbadbots")),
				array('value'=>'7', 'label' => __('7 days', "stopbadbots")),
				array('value'=>'14', 'label' => __('14 days', "stopbadbots")),
				array('value'=>'21', 'label' => __('21 days', "stopbadbots")),
				array('value'=>'30', 'label' => __('30 days', "stopbadbots")),
				)			
			);	
		$fields[] = array(
			'type' 	=> 'radio',
...
$fields[] = array(
	...
	'value' => 'red', // (optional, will default to '')
	'select_options' => array(
		array('value'=>'unlimited', 'label' => __('Unlimited', "stopbadbots")),
		array('value'=>'1', 'label' => __('1 per minute', "stopbadbots")),
		array('value'=>'2', 'label' => __('2 per minute', "stopbadbots")),
		array('value'=>'3', 'label' => __('3 per minute', "stopbadbots")),
		array('value'=>'4', 'label' => __('4 per minute', "stopbadbots")),
		array('value'=>'5', 'label' => __('5 per minute', "stopbadbots")),
		array('value'=>'10', 'label' => __('10 per minute', "stopbadbots")),
		array('value'=>'20', 'label' => __('20 per minute', "stopbadbots")),
		array('value'=>'50', 'label' => __('50 per minute', "stopbadbots"))
	...
	$fields[] = array(
		...
		'select_options' => array(
			array('value'=>'unlimited', 'label' => __('Unlimited', "stopbadbots")),
			array('value'=>'1', 'label' => __('5 per hour', "stopbadbots")),
			array('value'=>'2', 'label' => __('10 per hour', "stopbadbots")),
			array('value'=>'3', 'label' => __('20 per hour', "stopbadbots")),
			array('value'=>'4', 'label' => __('50 per hour', "stopbadbots")),
			array('value'=>'5', 'label' => __('100 per hour', "stopbadbots"))
		...
		$fields[] = array(
			...
			'select_options' => array(
				array('value'=>'unlimited', 'label' => __('Unlimited', "stopbadbots")),
				array('value'=>'5', 'label' => __('five 404 pages', "stopbadbots")),
				array('value'=>'10', 'label' => __('ten 404 pages', "stopbadbots")),
				array('value'=>'15', 'label' => __('fifteen 404 pages', "stopbadbots")),
				array('value'=>'20', 'label' => __('twenty 404 pages', "stopbadbots")),
				array('value'=>'50', 'label' => __('fifty 404 pages', "stopbadbots")),
				)			
			);
			...
			$fields[] = array(
				...
				'value' => 'red', // (optional, will default to '')
				'select_options' => array(
					array('value'=>'2', 'label' => __('5 minutes', "stopbadbots")),
					array('value'=>'3', 'label' => __('30 minutes', "stopbadbots")),
					array('value'=>'4', 'label' => __('1 Hour', "stopbadbots")),
					array('value'=>'5', 'label' => __('2 Hours', "stopbadbots")),
					array('value'=>'6', 'label' => __('6 Hours', "stopbadbots")),
					array('value'=>'7', 'label' => __('24 Hours', "stopbadbots"))
...
$settings['Block HTTP Tools'][__('Instructions about to block HTTP tools (Only Pro)')] = array('info' => $msg2);
...
$msg .= '<br />';
$msg .= '<br />';
$msg .= __('Every day, hundreds of pieces of  malicious code and bots are creating
and are trying 
to mess up the day of many fine people who are just trying to work.' , 'stopbadbots');
$msg .= '<br />';
$msg .= __('We just created a new extension to protect against current and future bots
using invisible reCAPTCHA Google technology in all pages of your site.' , 'stopbadbots');
$msg .= '<br />';
$msg .= __('To install it, just go to General Settings tab on this page and mark
Enable reCAPTCHA extension reCAPTCHA For all.' , 'stopbadbots');
$msg .= '<br />';
...
if(is_multisite()){
	...
	$msg =  '<script>';
	$msg .= 'window.location.replace("'.esc_url(STOPBADBOTSHOMEURL).'/admin.php?page=stopbadbots_new_more_plugins");';
...
$fields[] = array(
	...
	'label' => 'Purchase Code (just paste here to activate your product):',
	);   

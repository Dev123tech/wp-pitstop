...
* Hide Admin Bar menus for none White Label Admins. Supports frontend & backend admin bar menus.
* Remove WordPress Update Nags
* Redirect Users on login.
* Remove the entire admin bar for non-White Label Admins.
...
* Ready & tested with WordPress 5.6
...
* Ready & tested with WordPress 5.5

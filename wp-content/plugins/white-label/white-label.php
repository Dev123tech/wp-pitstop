 ...
 * Description:       White Label allows your agency to customize WordPress branding, admin area, dashboard, and login page.
 * Version:           2.1.2
 * Author:            whitewp.com
...
class WHITEWP_Init {
	...
	public function activation() {
		$text = __(
			'Thank you for installing White Label! Get started White Labelling your site now.',
			'white-label'
	...
	public function dependencies() {
		...
		$message = __( 'Success! White Label settings has been imported. Please set your White Label Administrators as they differer from site to site.', 'white-label' );
		...
		if ( $enable_white_label === 'on' ) {
			...
			include_once plugin_dir_path( __FILE__ ) . 'functions/menus-plugins.php';
